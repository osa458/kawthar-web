 ...
 */ export const generateSlug = ({ fieldName = 'slug', fieldToUse })=>async (args)=>{
        ...
        if (operation === 'update') {
            ...
            const autosaveEnabled = Boolean(typeof collection?.versions?.drafts === 'object' && collection?.versions?.drafts.autosave || typeof global?.versions?.drafts === 'object' && global?.versions?.drafts.autosave);
            if (!autosaveEnabled) {
